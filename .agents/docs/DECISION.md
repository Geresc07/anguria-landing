...
- Diseño No-Genérico: Evitar el aspecto típico de IA mediante una **Terminal macOS interactiva** customizada. El centro de la experiencia es la animación de tecleo y el despliegue de comandos que revelan la oferta de valor. Se descartan assets 3D genéricos para priorizar una estética de "herramienta de ingeniería premium".
- Glassmorphism logrado con utilities: `bg-white/5 backdrop-blur-3xl border border-white/10`.
