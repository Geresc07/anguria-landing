...
- **Estructuras Restringidas:**
  ...
  - **Hero Section:** Experiencia de terminal macOS inmersiva. Animación de escritura literal de `/ANGURIA_`. Al finalizar, se despliegan los CTAs centrales. Sin distracciones 3D, enfoque total en el mensaje y la conversión. El texto es el REY.
