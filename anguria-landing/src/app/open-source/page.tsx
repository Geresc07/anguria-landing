  ...
  return (
    <main className="bg-black min-h-screen text-white">
      ...
      <div className="w-full border-b border-white/[0.06] px-8 py-4 flex items-center gap-4">
        ...
        <span className="text-sm font-mono text-white/20">Open Source</span>
        <ChevronRight className="w-3 h-3 text-white/10" />
        <span className="text-sm font-mono text-white/40">Envy</span>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto px-8 pt-14 pb-10">
        <div className="flex items-start justify-between gap-8">
          <div className="flex items-start gap-6">
            ...
            {/* Meta */}
            <div className="pt-1">
              <h1 className="text-2xl font-black tracking-tight leading-none mb-1.5">Envy</h1>
              ...
              <div className="flex items-center gap-4 text-[12px] font-mono text-white/25">
                <div className="flex items-center gap-1.5">
                  <Code2 className="w-3 h-3" />Rust
                </div>
                <span className="text-white/10">|</span>
                <div className="flex items-center gap-1.5">
                  <Star className="w-3 h-3" />MIT License
                </div>
                <span className="text-white/10">|</span>
                <div className="flex items-center gap-1.5">
                  <Database className="w-3 h-3" />AES-256-GCM · Argon2id · SQLCipher
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-2 shrink-0 pt-1">
            ...
            <Link
              ...
              target="_blank"
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-white/10 text-white/60 text-sm font-medium hover:border-white/20 hover:text-white transition-all duration-200"
            >
