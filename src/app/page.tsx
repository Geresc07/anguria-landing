...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background relative flex flex-col items-center pt-32 lg:pt-48 overflow-hidden">
      ...
      <nav className="absolute top-0 w-full p-6 flex justify-between items-center z-50 max-w-screen-2xl mx-auto">
        <div className="text-xl font-black tracking-tighter">ANGURIA<span className="text-accent-orange">_</span></div>
        <Link 
      ...
      <header className="z-10 text-center px-4 w-full max-w-5xl mx-auto flex flex-col items-center">
        <motion.div
          initial={{ opacity: 0, y: 20, scale: 0.95 }}
          animate={{ opacity: 1, y: 0, scale: 1 }}
          transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass text-xs font-mono uppercase tracking-widest text-accent-orange-glow mb-8 border border-accent-orange/20 shadow-2xl"
        >
        ...
        <motion.h1 
          className="text-6xl md:text-8xl lg:text-[6.5rem] font-black tracking-tighter mb-8 leading-[1]"
        ...
        <motion.p 
          className="text-xl md:text-2xl text-gray-400 mb-12 max-w-3xl leading-relaxed mx-auto text-balance"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link 
            href="https://calendly.com" 
            target="_blank"
            className="group relative inline-flex items-center justify-center gap-3 bg-accent-orange text-black px-8 py-4 rounded-full font-bold overflow-hidden transition-all hover:scale-[1.03] active:scale-[0.98] shadow-[0_0_40px_-5px_rgba(249,115,22,0.4)] hover:shadow-[0_0_60px_-10px_rgba(249,115,22,0.6)]"
          >
            <span>{dict.hero.ctaPrimary}</span>
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Link>
          
          <button className="glass px-8 py-4 rounded-full font-medium hover:bg-white/10 hover:border-white/20 transition-all flex items-center justify-center gap-2 group active:scale-[0.98]">
            <Terminal className="w-4 h-4 text-accent-orange-dark group-hover:text-accent-orange transition-colors" />
            <span className="text-gray-300 group-hover:text-white transition-colors">{dict.hero.ctaSecondary}</span>
          </button>
        </motion.div>
      </header>
